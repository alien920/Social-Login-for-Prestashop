...
/*
  ...
  */    
  public function getContent(){
	...
	<img src="../img/t/AdminTranslations.gif" style="margin-right:5px"><a href="index.php?tab=AdminTranslations&token='.Tools::getAdminToken('AdminTranslations'.intval(33).intval($cookie->id_employee)).'&type=modules#prestashop_sociallogin_sociallogin">Social Login module Translation</a></div>
	...
	<span class="subhead">'.$this->l('What Social Sharing widget theme do you want to use across your website?').'</span><br /><br />';
	  $style_visible= 'style="position:absolute;border-bottom:8px solid #EBEBEB; border-right:8px solid transparent; border-left:8px solid transparent; margin:-28px 0 0 2px"';
...
<label for="hybrid-verticle-horizontal"> 	<input name="chooseverticalshare" id = "hybrid-verticle-horizontal" '.(Configuration::get('chooseverticalshare') == 7 ? 'checked="checked"' : '').'  type="radio" value="7" style="vertical-align:top" onclick ="loginradius_vertical_counter();"/><img src = "../modules/sociallogin/img/hybrid-verticle-horizontal.png" style="vertical-align:top"/></label>
	...
	<p align="justify" style="line-height: 19px; font-size:12px !important; margin:10px !important;color: #000000;">
	If you liked our FREE open-source plugin, please send your feedback/testimonial to <a style="color:#0088CC;" href="mailto:feedback@loginradius.com">feedback@loginradius.com</a>!</p>
	</div>
	</div>
	</div>';
	return $html;
