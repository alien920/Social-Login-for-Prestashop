					...
					if (!empty($data['country']) && !empty($data['zipcode']))
					{
						...
						if (!empty($zip_code_format))
						{
							...
							if (!preg_match($zip_regexp, $postcode))
							{
								...
								style="color: red;margin-bottom: -20px; font-size: 10px;">'.$module->l('Your zip/postal code is incorrect.').'<br />
...
SQLQUERY;
	...
	*/
	...
	'.$this->l('To activate the extension, please configure it and manage the social networks from your LoginRadius account.
	 you do not have an account, click').'<a href="http://www.loginradius.com" target="_blank"> here </a>'.$this->l('and create one for FREE!').'
	</div>
	<div class="row" style="color: #000000; width:90%; line-height:160%; background:none;">
...
onclick ="loginradius_horizontal_hybrid();" /><img src = "../modules/sociallogin/img/hybrid-horizontal-horizontal.png" /><br /><br /></label>
	...
	<strong>'.$this->l('Specify distance of vertical sharing interface from top. (Leave empty for default behaviour)').'</strong>
	<a title="'.$this->l('Enter a number (For example - 200). It will set the \'top\' CSS attribute of the interface to the value specified.
	Increase in the number pushes interface towards bottom.')
	...
	sharing networks will be shown as part of LoginRadius sharing icon)').'</span><br /><div id="loginRadiusSharingLimit"
	...
	<ul class="help_ul">
	<li><a href="http://support.loginradius.com/customer/portal/articles/1107175-implementation-of-social-login-on-prestashop-v1-5-website"
	target="_blank">
	'.$this->l('Plugin Installation, Configuration and Troubleshooting').'</a></li>
	<li><a href="http://support.loginradius.com/customer/portal/articles/677100-how-to-get-loginradius-api-key-and-secret" target="_blank">
	'.$this->l('How to get LoginRadius API Key & Secret').'</a></li>
	...
	*/
	public static function jsinterface()
	{
		...
		$loginradius_interface = '<ul style="list-style:none">';
		if (Context::getContext()->customer->isLogged())
		{
